...
echo "chr37	pos37	pos37b	rsId37	chr36	pos36	rsId36	A1	A2	beta	pvalue" > ${CLUMP_DIR}/overlapped_gwas_stats.bed

bedtools intersect -a ${SUMMARY} -b ${DHS_PEAKS} >> ${CLUMP_DIR}/overlapped_gwas_stats.bed

SUMMARY=${CLUMP_DIR}/overlapped_gwas_stats.bed
